        ...
        <Section crosses>
            <div className='container lg:flex'>
                <div className='max-w-[25rem]'>
                    <h2 className='h2 mb-4 md:mb-8'>AI Chat App for seamlees collaboration</h2>
                ...
                <div className='lg:ml-auto xl:w-[38rem] mt-5'>
                    ...
                    <div className='relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2  scale-75 md:scale-100 xl:scale-125'>
                        <div className='flex w-60 aspect-square m-auto border border-n-6 rounded-full'>
                            <div className='w-[6rem] aspect-square m-auto p-[0.2rem] rounded-full bg-conic-gradient'>
                                <div className=' flex rounded-full bg-n-8 h-full w-full justify-center items-center'>
                            ...
                            {collabApps.map((app, index) => (
                                <li key={app.id} className={`absolute top-0 left-1/2 h-1/2 -ml-[1.6rem] origin-bottom rotate-${index * 45}`}>
                                    <div className={`relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1/15 rounded-xl -rotate-${index * 45}`}>
                                        <img src={app.icon} className='m-auto' width={app.width} height={app.height} />
                                    </div>
                                </li>
                            ))}
                        </ul>
